(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pago-predial-pago-predial-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PagoPredialPageModule = /** @class */ (function () {
                function PagoPredialPageModule() {
                }
                return PagoPredialPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PagoPredialPage = /** @class */ (function () {
                function PagoPredialPage(router, route, domSanitizer, inappbrowser) {
                    this.router = router;
                    this.route = route;
                ...
                PagoPredialPage.prototype.ngOnInit = function () {
                };
                PagoPredialPage.prototype.openUrlInAppBrowser = function () {
                    var browser = this.inappbrowser.create('https://www.stackoverflow.com', '_self', this.iabOptions);
                };
                return PagoPredialPage;
            }());
            PagoPredialPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pago-predial-pago-predial-module-es5.js.map
//# sourceMappingURL=pago-predial-pago-predial-module-es5.js.map