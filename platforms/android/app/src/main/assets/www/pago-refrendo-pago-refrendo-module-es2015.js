...
let PagoRefrendoPageModule = class PagoRefrendoPageModule {
};
...
let PagoRefrendoPage = class PagoRefrendoPage {
    constructor(router, route, domSanitizer) {
        this.router = router;
        this.route = route;
...
PagoRefrendoPage.ctorParameters = () => [
